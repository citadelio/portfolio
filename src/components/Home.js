		...
		<div className="custom-container">
			...
			<div className="hero-social">
                ...
                <li className="flex-fill">
						<a href="https://github.com/citadelio" target="_blank" rel="noopener noreferrer" className="ease-3">
					...
					<li className="flex-fill">
						<a href="https://twitter.com/sudo_hussein" target="_blank" rel="noopener noreferrer" className="ease-3">
					...
					<li className="flex-fill">
						<a href="https://www.facebook.com/Warrake.H" target="_blank" rel="noopener noreferrer" className="ease-3">
                    ...
                    <li className="flex-fill">
						<a href="https://wa.me/2349039951233?text=Hi%20Hussein,%20I'm%20coming%20from%20your%20personal%20website%20-ENTER%20YOUR%20MESSAGE%20HERE-" target="_blank" rel="noopener noreferrer" className="ease-3">
